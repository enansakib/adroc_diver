...
class ADROC_Action:
    ...
    def __init__(self, name):
        ...
        rospy.Subscriber ('/mavros/imu/data', Imu, self.get_rotation)
        self.drp_msgs = list()
        self.last_drp_msg = 0
        ...
        self.ref_q_list = [0.0, 0.0, 0.0, 1.0]
    ...
    def get_rotation (self, msg):
        self.initialized_q, self.ref_q_list
        if not self.initialized_q:
            ref_q = msg.orientation
            self.ref_q_list = [ref_q.x, ref_q.y, ref_q.z, -ref_q.w]
            self.initialized_q = True
        
        orientation_q = msg.orientation
        orientation_list = [orientation_q.x, orientation_q.y, orientation_q.z, orientation_q.w]
        qr = quaternion_multiply(orientation_list, self.ref_q_list)
        (roll, pitch, yaw) = euler_from_quaternion (qr)
        roll_ang = roll*180/math.pi
        pitch_ang = pitch*180/math.pi
        yaw_ang = yaw*180/math.pi
        ...
        self.yaw_angle = yaw_ang
        # print("rel ang", initialized_q, roll_ang, pitch_ang, yaw_ang)
