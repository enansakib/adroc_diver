...
class ADROC_Action:
    ...
    def __init__(self, name):
        ...
        self.TARGET_DIVER = 3 #this will only be used when the script is initially run with self.TRAINING_DONE = True
    ...
    def drp_stable(self):
        if len(self.drp_msgs) >0:
            ...
            image_setpoint_y = self.drp_msgs[0].image_h/3 #########
    ...
    def run(self):
        ...
        if self.state == ADROCState.INIT:
            ...
            self.perform_TimedYaw(70) ## TUNE this argument, increasing will make it more yaw
