...
class ADROC_Action:
    ...
    def __init__(self, name):
        ...
        self.model = 'svm' ## ['nn-knn', nn-svm', 'knn', 'svm']
        self.n_neighbors = 5
    ...
    def perform_TimedYaw(self, counter):
        ...
        self.search_it_count = 0
        time.sleep(10) ## we add this for testing on bench, to have time between switching people
        return
    ...
    def run(self):
        if self.state == ADROCState.INIT:
            ...
            self.TARGET_DIVER = 1 ## This is the variable to be used for comparison for online deployment
