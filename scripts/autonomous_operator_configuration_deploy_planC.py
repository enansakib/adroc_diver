...
## GLOBAL VARIABLES
DIVERS_NUM = 2
FRAMES_THR = 20 ## this is the number of frames we will use for inference
# TRAINING_DONE = False
DETECTION_THR = 0.5
# TARGET_DIVER = 4 #3
...
class ADROC_Action:
    ...
    def __init__(self, name):
        ...
        self.TARGET_DIVER = 0 #this will only be used when the script is initially run with self.TRAINING_DONE = True
